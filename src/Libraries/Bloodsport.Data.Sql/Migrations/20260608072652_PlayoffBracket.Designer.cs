...
namespace Bloodsport.Data.Sql.Migrations
{
    ...
    [Migration("20260608072652_PlayoffBracket")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bloodsport.Entity.Database.PlayoffMatchupResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("PlayoffMatchupId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PlayoffMatchupId")
                        .IsUnique();

                    b.HasIndex("WinnerTeamId");

                    b.ToTable("PlayoffMatchupResults");
                });
            ...
            modelBuilder.Entity("Bloodsport.Entity.Database.PlayoffMatchupResult", b =>
                {
                    b.HasOne("Bloodsport.Entity.Database.PlayoffMatchup", "PlayoffMatchup")
                        .WithOne("PlayoffMatchupResult")
                        .HasForeignKey("Bloodsport.Entity.Database.PlayoffMatchupResult", "PlayoffMatchupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bloodsport.Entity.Database.PlayoffMatchup", b =>
                {
                    b.Navigation("PlayoffMatchupResult");
                });
