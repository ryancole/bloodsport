...
public class HandleUserLogo(ILogger<HandleUserLogo> logger, BlobServiceClient blobServiceClient)
{
    private const string Container = "bs-user-logo";
    private const int FlagWidth = 28;
    private const int FlagHeight = 18;

    [Function(nameof(HandleUserLogo))]
